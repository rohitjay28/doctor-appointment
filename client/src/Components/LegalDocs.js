    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Doctor appointment, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Doctor appointment, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          doctor-appointment is designed to simplify healthcare access. You can choose
